...
import doc1 from './../../../imgs/about/1.jpg'
import doc2 from './../../../imgs/about/2.jpg'
import doc3 from './../../../imgs/about/3.jpg'
import square from '../../../imgs/6.png'
import zigzag  from '../../../imgs/9.png'
import emptyCircle  from '../../../imgs/1.png'
import borderSquare  from '../../../imgs/2.png'

const About = () => {
    return (
        <div className='about-area section-sp1 '>
            <div className="container">
                <div className="row align-items-center flip-direct"  style={{zIndex:'3', position:'relative'}}>
                    {/* Gallery */}
                    <div className="gallery col-lg-6 mb-30 row">
                        <div className='sec-gallery doc2'>
                            <img src={doc2} alt='doc'/>
                        </div>
                        <div className='sec-gallery doc1'>
                            <img src={doc3} alt='doc'/>
                        </div>
                        <div className='sec-gallery doc3'>
                            <img src={doc1} alt='doc'/>
                        </div>
                        <div className='sec-gallery exp'>
                            <span className='num'>20</span>
                            <span className='title'>Year Experience</span>
                        </div>
                    </div>
                    {/* Icons */}
                    <div className="col-lg-6 sec-info">
                        <div className='about-info'>
                            <h5 className='about-title'>About Us</h5>
                            <h1 className='main-title'>The Great Place Of Medical Hospital Center</h1>
                            <p style={{color: '#555', fontWeight: '500',fontSize: '18px'}}>We provide the special tips and advice’s of heath care treatment and high level of best technology involve in the our hospital.</p>
                        </div>
                        <div className="row icons">
                            <div className="col-lg-6 col-sm-6 mb-4 mb-sm-20">
            ...
            <img src={square} alt='shape' className='position-absolute square-rotate square-rotate-r  hide' style={{top: '20%',right: '2.2%', zIndex: '2'}}/>
            <img src={emptyCircle} alt='shape' className='position-absolute emptyCircle hide' style={{bottom: '2%',left: '75%', zIndex: '2'}}/>
            <img src={borderSquare} alt='shape' className='position-absolute borderSquare-r borderSquare hide' style={{top: '70%',right: '1%', zIndex: '2'}}/>
            <img src={zigzag} alt='shape' className='position-absolute zigzag  hide' style={{top: '75%',left: '5%', zIndex: '2'}}/>
        </div>
    )
}
