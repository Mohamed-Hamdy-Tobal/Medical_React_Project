...
import BestDoctors from '../../Pages/MainAbout/BestDoctors'
import News from '../../Home/Pages/News'
import FirstTeam from '../../Pages/Team/FirstTeam'

const ServiceMain = () => {
    return (
        <>
            <Banner bannerTitle="Service" path="Service"/>
            <div className="service-page">
                <div className='container'>
                    <div class="row justify-content-center">
                        <div className="slide col-lg-4 col-sm-6 mb-30 main-box">
                            <div className='box'>
